...
CREATE TABLE `conditions` (
  ...
  PRIMARY KEY (`SourceTypeOrReferenceId`,`SourceGroup`,`SourceEntry`,`SourceId`,`ElseGroup`,`ConditionTypeOrReference`,`ConditionValue1`,`ConditionValue2`,`ConditionValue3`)
...
CREATE TABLE `creature` (
  ...
  KEY `idx_map` (`map`),
  KEY `idx_id` (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=5140666 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='Creature System';
...
/*Table structure for table `extended_cost_2` */

DROP TABLE IF EXISTS `extended_cost_2`;

CREATE TABLE `extended_cost_2` (
  `id` mediumint(8) unsigned NOT NULL DEFAULT '0',
  `required_2v2_rating` smallint(5) unsigned NOT NULL DEFAULT '0',
  `required_3v3_rating` smallint(5) unsigned NOT NULL DEFAULT '0',
  `required_5v5_rating` smallint(5) unsigned NOT NULL DEFAULT '0',
  `required_title` tinyint(3) unsigned NOT NULL DEFAULT '0',
  `required_item_id` mediumint(8) unsigned NOT NULL DEFAULT '0',
  `required_item_count` mediumint(8) unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
...
CREATE TABLE `game_tele` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=1781 DEFAULT CHARSET=utf8 COMMENT='Tele Command';
...
CREATE TABLE `info_text` (
  ...
  `SubMenuId` mediumint(8) unsigned NOT NULL DEFAULT '0',
  `MenuTitle` varchar(255) DEFAULT NULL,
  `NpcTextId` mediumint(8) unsigned NOT NULL DEFAULT '1',
  PRIMARY KEY (`MenuId`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

/*Table structure for table `init_spells` */

DROP TABLE IF EXISTS `init_spells`;

CREATE TABLE `init_spells` (
  `spellId` int(10) unsigned NOT NULL DEFAULT '0',
  `requiredRace` mediumint(8) unsigned NOT NULL DEFAULT '0',
  `requiredClass` mediumint(8) unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE `item_template` (
  ...
  `ExtendedCost2` int(10) unsigned NOT NULL DEFAULT '0',
  `WDBVerified` smallint(5) DEFAULT '1',
  PRIMARY KEY (`entry`),
  KEY `idx_name` (`name`),
...
CREATE TABLE `npc_trainer` (
  ...
  `reqclass` smallint(4) NOT NULL DEFAULT '-1',
...
CREATE TABLE `npc_vendor` (
  `entry` mediumint(8) unsigned NOT NULL DEFAULT '0',
  `slot` mediumint(8) NOT NULL DEFAULT '0',
...
CREATE TABLE `quest_template` (
  ...
  `RewardXPId` tinyint(2) unsigned NOT NULL DEFAULT '0',
  ...
  `RewardHonor` int(10) NOT NULL DEFAULT '0',
  ...
  `RewardFactionValueId1` mediumint(6) NOT NULL DEFAULT '0',
  `RewardFactionValueId2` mediumint(6) NOT NULL DEFAULT '0',
  `RewardFactionValueId3` mediumint(6) NOT NULL DEFAULT '0',
  `RewardFactionValueId4` mediumint(6) NOT NULL DEFAULT '0',
  `RewardFactionValueId5` mediumint(6) NOT NULL DEFAULT '0',
  `RewardFactionValueIdOverride1` mediumint(9) NOT NULL DEFAULT '0',
  `RewardFactionValueIdOverride2` mediumint(9) NOT NULL DEFAULT '0',
  `RewardFactionValueIdOverride3` mediumint(9) NOT NULL DEFAULT '0',
  `RewardFactionValueIdOverride4` mediumint(9) NOT NULL DEFAULT '0',
  `RewardFactionValueIdOverride5` mediumint(9) NOT NULL DEFAULT '0',
  ...
  `Unknown0` tinyint(2) unsigned NOT NULL DEFAULT '0',
  `ObjectiveText1` text,
  `ObjectiveText2` text,
  `ObjectiveText3` text,
  `ObjectiveText4` text,
