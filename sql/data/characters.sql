...
CREATE TABLE `arena_team_member` (
  `arenaTeamMemberId` int(10) NOT NULL AUTO_INCREMENT,
  `arenaTeamId` int(10) unsigned NOT NULL DEFAULT '0',
  ...
  PRIMARY KEY (`arenaTeamMemberId`),
  UNIQUE KEY `UQ_arena_team_member__guid__arenaTeamId` (`arenaTeamId`,`guid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `character_arena_stats` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `guid__slot` (`guid`,`slot`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `character_equipmentsets` (
  ...
  `setindex` int(3) unsigned NOT NULL DEFAULT '0',
...
/*Table structure for table `character_personalqueue` */

DROP TABLE IF EXISTS `character_personalqueue`;

CREATE TABLE `character_personalqueue` (
...
/*Data for the table `character_personalqueue` */
...
CREATE TABLE `character_pvp_stats` (
  `guid` int(10) unsigned NOT NULL DEFAULT '0',
  `Lifetime2v2Rating` smallint(5) unsigned NOT NULL DEFAULT '1000',
  `Lifetime2v2MMR` smallint(5) unsigned NOT NULL DEFAULT '1500',
  `Lifetime2v2Wins` smallint(5) unsigned NOT NULL DEFAULT '0',
  `Lifetime2v2Games` smallint(5) unsigned NOT NULL DEFAULT '0',
  `Lifetime3v3Rating` smallint(5) unsigned NOT NULL DEFAULT '1000',
  `Lifetime3v3MMR` smallint(5) unsigned NOT NULL DEFAULT '1500',
  `Lifetime3v3Wins` smallint(5) unsigned NOT NULL DEFAULT '0',
  `Lifetime3v3Games` smallint(5) unsigned NOT NULL DEFAULT '0',
  `Lifetime5v5Rating` smallint(5) unsigned NOT NULL DEFAULT '1000',
  `Lifetime5v5MMR` smallint(5) unsigned NOT NULL DEFAULT '1500',
  `Lifetime5v5Wins` smallint(5) unsigned NOT NULL DEFAULT '0',
  `Lifetime5v5Games` smallint(5) unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`guid`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
/*Table structure for table `character_transmog_sets` */
...
/*Data for the table `character_transmog_sets` */
...
CREATE TABLE `characters` (
  ...
  `taxi_path` text,
  `weeklyArenaPoints` int(10) unsigned NOT NULL DEFAULT '0',
  `totalArenaPoints` int(10) unsigned NOT NULL DEFAULT '0',
  `arenaPointsCap` mediumint(5) unsigned NOT NULL DEFAULT '0',
  ...
  `spec` mediumint(3) unsigned NOT NULL DEFAULT '0',
  `arenaPoints` int(5) DEFAULT NULL,
  PRIMARY KEY (`guid`),
...
CREATE TABLE `item_instance` (
  ...
  `text` text,
  `TransmogEntry` int(6) unsigned NOT NULL DEFAULT '0',
  `TransmogEnchant` mediumint(5) unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`guid`),
...
CREATE TABLE `mailqueue` (
  ...
  `has_items` smallint(1) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
