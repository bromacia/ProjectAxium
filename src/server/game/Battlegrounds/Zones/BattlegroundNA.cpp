...
{
    for (uint8 i = BG_NA_OBJECT_DOOR_1; i <= BG_NA_OBJECT_DOOR_4; ++i)
...
bool BattlegroundNA::SetupBattleground()
{
    ...
    // Ready Markers
    if (!AddObject(BG_NA_OBJECT_READY_MARKER_A, BG_OBJECTID_READY_MARKER, 4023.31f, 2966.2f, 12.2f, 2.0f, 0, 0, 0, 0, RESPAWN_IMMEDIATELY) ||
        !AddObject(BG_NA_OBJECT_READY_MARKER_B, BG_OBJECTID_READY_MARKER, 4089.86f, 2875.1f, 12.16f, 5.17f, 0, 0, 0, 0, RESPAWN_IMMEDIATELY))
    {
        sLog->outErrorDb("BatteGroundNA: Failed to spawn Ready Markers Battleground not created!");
        return false;
    }
