...
TotemAI::UpdateAI(const uint32 /*diff*/)
{
    ...
    {
        victim = NULL;
        Axium::NearestAttackableUnitInObjectRangeCheck u_check(me, me, max_range);
        Axium::UnitLastSearcher<Axium::NearestAttackableUnitInObjectRangeCheck> checker(me, victim, u_check);
