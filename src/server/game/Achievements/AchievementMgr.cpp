...
void AchievementMgr::SendAchievementEarned(AchievementEntry const* achievement) const
{
    ...
    {
        Axium::AchievementChatBuilder say_builder(*GetPlayer(), CHAT_MSG_GUILD_ACHIEVEMENT, LANG_ACHIEVEMENT_EARNED, achievement->ID);
        Axium::LocalizedPacketDo<Axium::AchievementChatBuilder> say_do(say_builder);
    ...
    else if (GetPlayer()->IsInWorld() && !GetPlayer()->IsInMall())
    {
        ...
        Axium::AchievementChatBuilder say_builder(*GetPlayer(), CHAT_MSG_ACHIEVEMENT, LANG_ACHIEVEMENT_EARNED, achievement->ID);
        Axium::LocalizedPacketDo<Axium::AchievementChatBuilder> say_do(say_builder);
        Axium::PlayerDistWorker<Axium::LocalizedPacketDo<Axium::AchievementChatBuilder> > say_worker(GetPlayer(), sWorld->getFloatConfig(CONFIG_LISTEN_RANGE_SAY), say_do);
        TypeContainerVisitor<Axium::PlayerDistWorker<Axium::LocalizedPacketDo<Axium::AchievementChatBuilder> >, WorldTypeMapContainer > message(say_worker);
