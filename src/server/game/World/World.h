...
enum WorldBoolConfigs
{
    ...
    CONFIG_IP_LOG_ENABLED,
    CONFIG_WARDEN_ENABLED,
    CONFIG_ENABLE_MMAPS,
    CONFIG_HEALER_ONLY_BAUBLE,
    CONFIG_GLOBAL_ADJUSTMENT,
    CONFIG_DBCHATLOG_ENABLED,
...
enum WorldFloatConfigs
{
    ...
    CONFIG_DMG_ADJ_WARRIOR_DEFAULT,
    CONFIG_DMG_ADJ_WARRIOR_ARMS,
    CONFIG_DMG_ADJ_WARRIOR_FURY,
    CONFIG_DMG_ADJ_WARRIOR_PROT,
    CONFIG_DMG_ADJ_PALADIN_DEFAULT,
    CONFIG_DMG_ADJ_PALADIN_HOLY,
    CONFIG_DMG_ADJ_PALADIN_PROT,
    CONFIG_DMG_ADJ_PALADIN_RET,
    CONFIG_DMG_ADJ_DEATHKNIGHT_DEFAULT,
    CONFIG_DMG_ADJ_DEATHKNIGHT_BLOOD,
    CONFIG_DMG_ADJ_DEATHKNIGHT_FROST,
    CONFIG_DMG_ADJ_DEATHKNIGHT_UNHOLY,
    CONFIG_DMG_ADJ_HUNTER_DEFAULT,
    CONFIG_DMG_ADJ_HUNTER_BM,
    CONFIG_DMG_ADJ_HUNTER_MARKS,
    CONFIG_DMG_ADJ_HUNTER_SURVIVAL,
    CONFIG_DMG_ADJ_SHAMAN_DEFAULT,
    CONFIG_DMG_ADJ_SHAMAN_ELE,
    CONFIG_DMG_ADJ_SHAMAN_ENH,
    CONFIG_DMG_ADJ_SHAMAN_RESTO,
    CONFIG_DMG_ADJ_ROGUE_DEFAULT,
    CONFIG_DMG_ADJ_ROGUE_MUTI,
    CONFIG_DMG_ADJ_ROGUE_COMBAT,
    CONFIG_DMG_ADJ_ROGUE_SUB,
    CONFIG_DMG_ADJ_DRUID_DEFAULT,
    CONFIG_DMG_ADJ_DRUID_BALANCE,
    CONFIG_DMG_ADJ_DRUID_FERAL,
    CONFIG_DMG_ADJ_DRUID_RESTO,
    CONFIG_DMG_ADJ_PRIEST_DEFAULT,
    CONFIG_DMG_ADJ_PRIEST_DISC,
    CONFIG_DMG_ADJ_PRIEST_HOLY,
    CONFIG_DMG_ADJ_PRIEST_SHADOW,
    CONFIG_DMG_ADJ_MAGE_DEFAULT,
    CONFIG_DMG_ADJ_MAGE_ARCANE,
    CONFIG_DMG_ADJ_MAGE_FIRE,
    CONFIG_DMG_ADJ_MAGE_FROST,
    CONFIG_DMG_ADJ_WARLOCK_DEFAULT,
    CONFIG_DMG_ADJ_WARLOCK_AFFI,
    CONFIG_DMG_ADJ_WARLOCK_DEMO,
    CONFIG_DMG_ADJ_WARLOCK_DESTRO,
    CONFIG_HEAL_ADJ_WARRIOR_DEFAULT,
    CONFIG_HEAL_ADJ_WARRIOR_ARMS,
    CONFIG_HEAL_ADJ_WARRIOR_FURY,
    CONFIG_HEAL_ADJ_WARRIOR_PROT,
    CONFIG_HEAL_ADJ_PALADIN_DEFAULT,
    CONFIG_HEAL_ADJ_PALADIN_HOLY,
    CONFIG_HEAL_ADJ_PALADIN_PROT,
    CONFIG_HEAL_ADJ_PALADIN_RET,
    CONFIG_HEAL_ADJ_DEATHKNIGHT_DEFAULT,
    CONFIG_HEAL_ADJ_DEATHKNIGHT_BLOOD,
    CONFIG_HEAL_ADJ_DEATHKNIGHT_FROST,
    CONFIG_HEAL_ADJ_DEATHKNIGHT_UNHOLY,
    CONFIG_HEAL_ADJ_HUNTER_DEFAULT,
    CONFIG_HEAL_ADJ_HUNTER_BM,
    CONFIG_HEAL_ADJ_HUNTER_MARKS,
    CONFIG_HEAL_ADJ_HUNTER_SURVIVAL,
    CONFIG_HEAL_ADJ_SHAMAN_DEFAULT,
    CONFIG_HEAL_ADJ_SHAMAN_ELE,
    CONFIG_HEAL_ADJ_SHAMAN_ENH,
    CONFIG_HEAL_ADJ_SHAMAN_RESTO,
    CONFIG_HEAL_ADJ_ROGUE_DEFAULT,
    CONFIG_HEAL_ADJ_ROGUE_MUTI,
    CONFIG_HEAL_ADJ_ROGUE_COMBAT,
    CONFIG_HEAL_ADJ_ROGUE_SUB,
    CONFIG_HEAL_ADJ_DRUID_DEFAULT,
    CONFIG_HEAL_ADJ_DRUID_BALANCE,
    CONFIG_HEAL_ADJ_DRUID_FERAL,
    CONFIG_HEAL_ADJ_DRUID_RESTO,
    CONFIG_HEAL_ADJ_PRIEST_DEFAULT,
    CONFIG_HEAL_ADJ_PRIEST_DISC,
    CONFIG_HEAL_ADJ_PRIEST_HOLY,
    CONFIG_HEAL_ADJ_PRIEST_SHADOW,
    CONFIG_HEAL_ADJ_MAGE_DEFAULT,
    CONFIG_HEAL_ADJ_MAGE_ARCANE,
    CONFIG_HEAL_ADJ_MAGE_FIRE,
    CONFIG_HEAL_ADJ_MAGE_FROST,
    CONFIG_HEAL_ADJ_WARLOCK_DEFAULT,
    CONFIG_HEAL_ADJ_WARLOCK_AFFI,
    CONFIG_HEAL_ADJ_WARLOCK_DEMO,
    CONFIG_HEAL_ADJ_WARLOCK_DESTRO,
...
enum WorldIntConfigs
{
    ...
    CONFIG_MAIL_QUEUE_TIMER,
    CONFIG_STEALTH_DETECTION_VALUE,
    CONFIG_DBCHATLOG_MINGMLEVEL,
    CONFIG_ARENA_SPECTATOR_MIN_RATING,
    CONFIG_CONFUSED_MOVEMENT_GENERATOR_RESET_TIME,
    CONFIG_FLEEING_MOVEMENT_GENERATOR_RESET_TIME,
    CONFIG_SPELL_DELAY_SPELL_TIME,
    CONFIG_MOVEMENT_DELAY_SPELL_TIME,
    CONFIG_SILENCE_DELAY_SPELL_TIME,
    CONFIG_MISC_DELAY_SPELL_TIME,
    CONFIG_COMBAT_DELAY,
    CONFIG_REQUIRED_2V2_CHARTER_SIGNATURES,
    CONFIG_REQUIRED_3V3_CHARTER_SIGNATURES,
    CONFIG_REQUIRED_5V5_CHARTER_SIGNATURES,
    CONFIG_ARENA_POINTS_CAP_MINIMUM_CAP,
    CONFIG_ARENA_POINTS_CAP_REQUIRED_GAMES,
