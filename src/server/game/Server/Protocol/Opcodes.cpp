...
OpcodeHandler opcodeTable[NUM_MSG_TYPES] =
{
    ...
    /*0x255*/ { "MSG_AUCTION_HELLO",                            STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_NULL                     },
    /*0x256*/ { "CMSG_AUCTION_SELL_ITEM",                       STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_NULL                     },
    /*0x257*/ { "CMSG_AUCTION_REMOVE_ITEM",                     STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_NULL                     },
    /*0x258*/ { "CMSG_AUCTION_LIST_ITEMS",                      STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_NULL                     },
    /*0x259*/ { "CMSG_AUCTION_LIST_OWNER_ITEMS",                STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_NULL                     },
    /*0x25A*/ { "CMSG_AUCTION_PLACE_BID",                       STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_NULL                     },
    ...
    /*0x264*/ { "CMSG_AUCTION_LIST_BIDDER_ITEMS",               STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_NULL                     },
    ...
    /*0x2D5*/ { "CMSG_BATTLEGROUND_QUEUE_RESULT",               STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleBattlegroundQueueResultOpcode},
    ...
    /*0x35C*/ { "CMSG_LFG_JOIN",                                STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_NULL                     },
    /*0x35D*/ { "CMSG_LFG_LEAVE",                               STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_NULL                     },
    /*0x35E*/ { "CMSG_SEARCH_LFG_JOIN",                         STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_NULL                     },
    /*0x35F*/ { "CMSG_SEARCH_LFG_LEAVE",                        STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_NULL                     },
    ...
    /*0x362*/ { "CMSG_LFG_PROPOSAL_RESULT",                     STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_NULL                     },
    ...
    /*0x366*/ { "CMSG_SET_LFG_COMMENT",                         STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_NULL                     },
    ...
    /*0x36E*/ { "CMSG_LFD_PLAYER_LOCK_INFO_REQUEST",            STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_NULL                     },
    ...
    /*0x371*/ { "CMSG_LFD_PARTY_LOCK_INFO_REQUEST",             STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_NULL                     },
    ...
    /*0x3AF*/ { "CMSG_VOICE_SESSION_ENABLE",                    STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_NULL                     },
    ...
    /*0x3D3*/ { "CMSG_SET_ACTIVE_VOICE_CHANNEL",                STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_NULL                     },
    ...
    /*0x3D6*/ { "CMSG_CHANNEL_VOICE_ON",                        STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_NULL                     },
    ...
    /*0x48F*/ { "CMSG_AUCTION_LIST_PENDING_SALES",              STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_NULL                     },
