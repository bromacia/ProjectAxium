...
// 2^n values, Player::m_isunderwater is a bitmask. These are Axium internal values, they are never send to any client
...
enum PlayerSpec
{
    PLAYERSPEC_MAGE_FIRE            = 41,
    PLAYERSPEC_MAGE_FROST           = 61,
    PLAYERSPEC_MAGE_ARCANE          = 81,
    PLAYERSPEC_WARRIOR_ARMS         = 161,
    PLAYERSPEC_WARRIOR_PROTECTION   = 163,
    PLAYERSPEC_WARRIOR_FURY         = 164,
    PLAYERSPEC_ROGUE_COMBAT         = 181,
    PLAYERSPEC_ROGUE_ASSASSINATION  = 182,
    PLAYERSPEC_ROGUE_SUBLETY        = 183,
    PLAYERSPEC_PRIEST_DISCIPLINE    = 201,
    PLAYERSPEC_PRIEST_HOLY          = 202,
    PLAYERSPEC_PRIEST_SHADOW        = 203,
    PLAYERSPEC_SHAMAN_ELEMENTAL     = 261,
    PLAYERSPEC_SHAMAN_RESTORATION   = 262,
    PLAYERSPEC_SHAMAN_ENHANCEMENT   = 263,
    PLAYERSPEC_DRUID_FERALCOMBAT    = 281,
    PLAYERSPEC_DRUID_RESTORATION    = 282,
    PLAYERSPEC_DRUID_BALANCE        = 283,
    PLAYERSPEC_WARLOCK_DESTRUCTION  = 301,
    PLAYERSPEC_WARLOCK_AFFLICTION   = 302,
    PLAYERSPEC_WARLOCK_DEMONOLOGY   = 303,
    PLAYERSPEC_HUNTER_BEASTMASTERY  = 361,
    PLAYERSPEC_HUNTER_SURVIVAL      = 362,
    PLAYERSPEC_HUNTER_MARKSMANSHIP  = 363,
...
class Player : public Unit, public GridObject<Player>
{
    ...
    public:
        ...
        void LogChatMessageToDB(const std::string& text, uint32 type, uint32 language, Player* receiver = NULL);
        ...
        bool addSpell(uint32 spellId, bool active, bool learning, bool dependent, bool disabled, bool loading = false, bool singleSpell = false);
        ...
        void RemoveAllPlayerSpellCooldowns();
