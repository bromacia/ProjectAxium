...
void VendorItemData::AddItem(uint32 item, int32 maxcount, uint32 ptime, uint32 ExtendedCost)
{
    ...
    switch (m_deathState)
    {
        ...
        case ALIVE:
        {
            ...
            bool bInCombat = isInCombat() && (!getVictim() ||                                             // if isInCombat() is true and this has no victim
                             ...
                             !getVictim()->GetCharmerOrOwnerPlayerOrPlayerItself()->HasGameMasterTagOn()); // or the victim/owner/charmer is not a GameMaster
...
void Creature::DoFleeToGetAssistance()
{
    ...
    if (radius >0)
    {
        ...
        Cell cell(p);
        cell.SetNoCreate();
        Axium::NearestAssistCreatureInCreatureRangeCheck u_check(this, getVictim(), radius);
        Axium::CreatureLastSearcher<Axium::NearestAssistCreatureInCreatureRangeCheck> searcher(this, creature, u_check);

        TypeContainerVisitor<Axium::CreatureLastSearcher<Axium::NearestAssistCreatureInCreatureRangeCheck>, GridTypeMapContainer > grid_creature_searcher(searcher);
...
Unit* Creature::SelectNearestTarget(float dist) const
{
...

    {
        ...
        Axium::NearestHostileUnitCheck u_check(this, dist);
        Axium::UnitLastSearcher<Axium::NearestHostileUnitCheck> searcher(this, target, u_check);

        TypeContainerVisitor<Axium::UnitLastSearcher<Axium::NearestHostileUnitCheck>, WorldTypeMapContainer > world_unit_searcher(searcher);
        TypeContainerVisitor<Axium::UnitLastSearcher<Axium::NearestHostileUnitCheck>, GridTypeMapContainer >  grid_unit_searcher(searcher);
...
Unit* Creature::SelectNearestTargetInAttackDistance(float dist) const
{
    ...
    {
        Axium::NearestHostileUnitInAttackDistanceCheck u_check(this, dist);
        Axium::UnitLastSearcher<Axium::NearestHostileUnitInAttackDistanceCheck> searcher(this, target, u_check);

        TypeContainerVisitor<Axium::UnitLastSearcher<Axium::NearestHostileUnitInAttackDistanceCheck>, WorldTypeMapContainer > world_unit_searcher(searcher);
        TypeContainerVisitor<Axium::UnitLastSearcher<Axium::NearestHostileUnitInAttackDistanceCheck>, GridTypeMapContainer >  grid_unit_searcher(searcher);
...
Player* Creature::SelectNearestPlayer(float distance) const
{
    ...
    Axium::NearestPlayerInObjectRangeCheck checker(this, distance);
    Axium::PlayerLastSearcher<Axium::NearestPlayerInObjectRangeCheck> searcher(this, target, checker);
    ...
    if (!m_AlreadyCallAssistance && getVictim() && !isPet() && !isCharmed())
    {
        ...
        if (radius > 0)
        {
...

            {
                ...
                Axium::AnyAssistCreatureInRangeCheck u_check(this, getVictim(), radius);
                Axium::CreatureListSearcher<Axium::AnyAssistCreatureInRangeCheck> searcher(this, assistList, u_check);

                TypeContainerVisitor<Axium::CreatureListSearcher<Axium::AnyAssistCreatureInRangeCheck>, GridTypeMapContainer >  grid_creature_searcher(searcher);
...
void Creature::CallForHelp(float radius)
{
    ...
    Axium::CallOfHelpCreatureInRangeDo u_do(this, getVictim(), radius);
    Axium::CreatureWorker<Axium::CallOfHelpCreatureInRangeDo> worker(this, u_do);

    TypeContainerVisitor<Axium::CreatureWorker<Axium::CallOfHelpCreatureInRangeDo>, GridTypeMapContainer >  grid_creature_searcher(worker);
...
void Creature::SetPosition(float x, float y, float z, float o)
{
    ...
    if (!Axium::IsValidMapCoord(x, y, z, o))
    {
