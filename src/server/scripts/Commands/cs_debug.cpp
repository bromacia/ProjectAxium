...
public:
    ...
    ChatCommand* GetCommands() const
    {
        ...
        static ChatCommand debugCommandTable[] =
        {
            ...
            { "anim",           SEC_ADMINISTRATOR,  false, &HandleDebugAnimCommand,             "", NULL },
            ...
            { "lootrecipient",  SEC_ADMINISTRATOR,  false, &HandleDebugGetLootRecipientCommand, "", NULL },
            ...
            { "los",            SEC_ADMINISTRATOR,  false, &HandleDebugLoSCommand,              "", NULL },
            { "visibility",     SEC_ADMINISTRATOR,  false, &HandleDebugVisibilityCommand,       "", NULL },
            { NULL,             0,                  false, NULL,                                "", NULL }
        };
    ...
    static bool HandleDebugEnterVehicleCommand(ChatHandler* handler, char const* args)
    {
        ...
        else
        {
            ...
            Axium::AllCreaturesOfEntryInRange check(handler->GetSession()->GetPlayer(), entry, 20.0f);
            Axium::CreatureSearcher<Axium::AllCreaturesOfEntryInRange> searcher(handler->GetSession()->GetPlayer(), passenger, check);
