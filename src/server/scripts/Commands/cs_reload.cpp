...
public:
    ...
    ChatCommand* GetCommands() const
    {
        ...
        static ChatCommand reloadCommandTable[] =
        {
            ...
            { "extendedcost2",                 SEC_ADMINISTRATOR, true,  &HandleReloadExtendedCost2Command,              "", NULL },
    ...
    static bool HandleReloadExtendedCost2Command(ChatHandler* handler, const char* /*args*/)
    {
        sLog->outString("Re-Loading ExtendedCost2...");
        sObjectMgr->LoadExtendedCost2();
        handler->SendGlobalGMSysMessage("ExtendedCost2 reloaded.");
        return true;
    }
