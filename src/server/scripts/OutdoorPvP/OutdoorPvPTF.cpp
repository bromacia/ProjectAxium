...
void OPvPCapturePointTF::ChangeState()
{
    ...
    if (m_OldState == OBJECTIVESTATE_ALLIANCE)
    {
        ...
        sWorld->SendZoneText(OutdoorPvPTFBuffZones[0], sObjectMgr->GetAxiumStringForDBCLocale(LANG_OPVP_TF_LOSE_A));
    }
    ...
    else if (m_OldState == OBJECTIVESTATE_HORDE)
    {
        ...
        sWorld->SendZoneText(OutdoorPvPTFBuffZones[0], sObjectMgr->GetAxiumStringForDBCLocale(LANG_OPVP_TF_LOSE_H));
    }
    ...
    case OBJECTIVESTATE_ALLIANCE:
    {
        ...
        if (alliance_towers < TF_TOWER_NUM)
            ((OutdoorPvPTF*)m_PvP)->SetAllianceTowersControlled(++alliance_towers);
        sWorld->SendZoneText(OutdoorPvPTFBuffZones[0], sObjectMgr->GetAxiumStringForDBCLocale(LANG_OPVP_TF_CAPTURE_A));
    ...
    case OBJECTIVESTATE_HORDE:
    {
        ...
        if (horde_towers < TF_TOWER_NUM)
            ((OutdoorPvPTF*)m_PvP)->SetHordeTowersControlled(++horde_towers);
        sWorld->SendZoneText(OutdoorPvPTFBuffZones[0], sObjectMgr->GetAxiumStringForDBCLocale(LANG_OPVP_TF_CAPTURE_H));
