...
void OPvPCapturePointHP::ChangeState()
{
    ...
    case OBJECTIVESTATE_ALLIANCE:
        ...
        sWorld->SendZoneText(OutdoorPvPHPBuffZones[0], sObjectMgr->GetAxiumStringForDBCLocale(HP_LANG_LOSE_A[m_TowerType]));
        break;
    case OBJECTIVESTATE_HORDE:
        ...
        sWorld->SendZoneText(OutdoorPvPHPBuffZones[0], sObjectMgr->GetAxiumStringForDBCLocale(HP_LANG_LOSE_H[m_TowerType]));
        break;
    ...
    switch (m_State)
    {
        ...
        case OBJECTIVESTATE_ALLIANCE:
        {
            ...
            if (alliance_towers < 3)
                ((OutdoorPvPHP*)m_PvP)->SetAllianceTowersControlled(++alliance_towers);
            sWorld->SendZoneText(OutdoorPvPHPBuffZones[0], sObjectMgr->GetAxiumStringForDBCLocale(HP_LANG_CAPTURE_A[m_TowerType]));
            break;
        }
        case OBJECTIVESTATE_HORDE:
        {
            ...
            if (horde_towers < 3)
                ((OutdoorPvPHP*)m_PvP)->SetHordeTowersControlled(++horde_towers);
            sWorld->SendZoneText(OutdoorPvPHPBuffZones[0], sObjectMgr->GetAxiumStringForDBCLocale(HP_LANG_CAPTURE_H[m_TowerType]));
            break;
        }
        case OBJECTIVESTATE_NEUTRAL_ALLIANCE_CHALLENGE:
            field = HP_MAP_N[m_TowerType];
