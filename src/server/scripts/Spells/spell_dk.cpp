...
class spell_dk_anti_magic_shell_self : public SpellScriptLoader
{
    public:
        ...
        class spell_dk_anti_magic_shell_self_AuraScript : public AuraScript
        {
            ...
            void CalculateAmount(AuraEffect const* /*aurEff*/, int32 & amount, bool & /*canBeRecalculated*/)
            {
                // Set absorbtion amount to 50% of the DK's total HP
    ...
    public:
        ...
        class spell_dk_scourge_strike_SpellScript : public SpellScript
        {
            ...
            void HandleDummy()
            {
                ...
                if (Unit* unitTarget = GetHitUnit())
                {
                    int32 bp = CalculatePctN(GetHitDamage(), GetSpellInfo()->Effects[2].BasePoints * unitTarget->GetDiseasesByCaster(caster->GetGUID()));
            ...
            void Register()
            {
                AfterHit += SpellHitFn(spell_dk_scourge_strike_SpellScript::HandleDummy);
            }
        };
